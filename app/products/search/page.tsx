...
import { Product } from "@/types/product"; // ✅ pastikan ada tipe Product

// Tipe opsional untuk filter
interface ProductFilters {
  category?: string;
  priceRange?: [number, number];
  [key: string]: unknown; // supaya fleksibel
}
...
export default function ProductSearchPage() {
  ...
  // ✅ Efek untuk memanggil pencarian setiap kali query atau filter berubah
  useEffect(() => {
    ...
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Temukan produk UMKM berdasarkan nama, kategori, atau deskripsi
        </p>
      </div>
